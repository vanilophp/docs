...
It is defined as a [HasMany Eloquent relationship](https://laravel.com/docs/13.x/eloquent-relationships#one-to-many)
...
The default Taxon model that ships with this package defines a several [Query Scopes](https://laravel.com/docs/13.x/eloquent#local-scopes).
...
[Eloquent Many To Many Polymorphic Relations](https://laravel.com/docs/13.x/eloquent-relationships#many-to-many-polymorphic-relations).
