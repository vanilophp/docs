...
1. Use the [scopes](https://laravel.com/docs/13.x/eloquent#local-scopes) directly,
...
[MorphToMany](https://laravel.com/docs/13.x/eloquent-relationships#many-to-many-polymorphic-relations)
relation, therefore multiple values can be
[synchronized](https://laravel.com/docs/13.x/eloquent-relationships#syncing-associations):
