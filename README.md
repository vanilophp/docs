...
branch. For example, documentation for Vanilo 5.x needs to be submitted to the `5.x` branch.

Documentation intended for the next major release (6.x) should be submitted to the `master` branch.
